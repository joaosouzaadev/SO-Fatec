...
Explique quais componentes do sistema operacional estão envolvidos durante a instalação e configuração do Windows.

Destaque:

Quais recursos precisam ser gerenciados;
Quais componentes são responsáveis por essas funções;
Em quais momentos esses componentes são necessários.
Kernel: O Núcleo do Sistema
Explique qual é a importância do kernel durante o processo.
...
Quais recursos precisam ser controlados durante a instalação?
Modos de Execução
Explique a diferença entre:

Modo Usuário
Modo Kernel
Identifique em quais momentos do processo de instalação esses modos estão envolvidos.

Explique também por que o sistema operacional não permite que qualquer programa tenha acesso direto e irrestrito ao hardware.

Processos
Identifique os principais processos envolvidos durante a instalação do Windows.
...
Escolha pelo menos um exemplo relacionado à instalação do Windows e explique a diferença entre:

Programa × Processo × Thread

Por exemplo, considere um programa responsável por uma etapa da instalação:
...
Sistema de Arquivos
Explique o papel do sistema de arquivos durante a formatação e instalação.

Aborde:

O que acontece com os dados existentes;
Formatação da unidade;
Criação/organização das estruturas necessárias;
...
Importante: diferencie apagar dados, particionar uma unidade e formatar um sistema de arquivos.

Entrada/Saída e Drivers de Dispositivos
Identifique os dispositivos de entrada e saída envolvidos durante o processo.
...
Destaque o papel dos drivers e explique por que eles são importantes durante e depois da instalação.
...
Explicação dos 7 conceitos solicitados;
Linha do tempo do processo;
Tabela relacionando cada etapa aos conceitos estudados;
